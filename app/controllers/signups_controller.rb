class SignupsController < ApplicationController
	...
	def create
      		if !@user
        		...
        		@user = User.new(:username => params['username'], :password => params['password'], :name => params['first_name'], :family_name => params['last_name'], :email => params['email'], :privilege_id => params['privilege_id'], :account_activated => false, :activation_code => s)
